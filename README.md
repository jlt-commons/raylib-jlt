...
**[Browse the full gallery →](docs/demos/README.md)**: 171 of the 183 examples, recorded via `bb record`.
...
- [`docs/guide/`](docs/guide/index.md): patterns & pitfalls, each with source
  ...
  - [`example-catalog.md`](docs/guide/example-catalog.md): a tour of all 183, and the five-touchpoint recipe for adding one
