...
**[Browse the full gallery →](docs/demos/README.md)**: all 187 examples, 171 of them recorded via `bb record` and the rest as single still frames.
...
- [`docs/guide/`](docs/guide/index.md): patterns & pitfalls, each with source
  ...
  - [`example-catalog.md`](docs/guide/example-catalog.md): a tour of all 187, and the five-touchpoint recipe for adding one

- Two galleries show the same 187 entries for different purposes.
