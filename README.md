...
- [`docs/guide/`](docs/guide/index.md): patterns & pitfalls, each with source
  ...
  - [`example-catalog.md`](docs/guide/example-catalog.md): a tour of all 126, and the five-touchpoint recipe for adding one

- Two galleries show the same 123 recordings for different purposes. 120 are
  ...
  123 recordings against 126 examples is not a mismatch to fix in the docs.
