...
- [`docs/guide/`](docs/guide/index.md): patterns & pitfalls, each with source
  ...
  - [`example-catalog.md`](docs/guide/example-catalog.md): a tour of all 138, and the five-touchpoint recipe for adding one

- Two galleries show the same 135 recordings for different purposes. 132 are
  ...
  135 recordings against 138 examples is not a mismatch to fix in the docs.
