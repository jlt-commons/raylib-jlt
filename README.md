...
- [`docs/guide/`](docs/guide/index.md): patterns & pitfalls, each with source
  ...
  - [`example-catalog.md`](docs/guide/example-catalog.md): a tour of all 146, and the five-touchpoint recipe for adding one

- Two galleries show the same 143 recordings for different purposes. 140 are
  ...
  143 recordings against 146 examples is not a mismatch to fix in the docs.
